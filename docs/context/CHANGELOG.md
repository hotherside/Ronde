...
- Added [ADR 0018](decisions/0018-clip-first-tracing-and-correction.md). Tracer implementation is committed at `1f95922`; the integration preserves the independently merged design PR #13. Delivery is recorded by Git and the final PR.
